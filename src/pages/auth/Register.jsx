...
const Register = () => {
  ...
  const getPasswordStrengthDescription = () => {
    if (passwordStrength < 25)
      return "Tambah lebih banyak karakter dan variasi";
  ...
  return (
    <AuthLayout
      ...
      brandingTitle={"Selamat Datang di MindLoop"}
      brandingDescription={
        "Platform literasi modern untuk belajar, berkembang, dan terhubung dengan komunitas pembaca cerdas"
      }
    >
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            ...
            {formData.role === "professional" &&
              "Konten relevan untuk profesional"}
            {formData.role === "lifelong_learner" &&
              "Jelajahi berbagai topik menarik"}
        ...
        <div className="space-y-4">
          <div className="flex items-start space-x-3">
            ...
            >
              ...
              MindLoop. Saya memahami bahwa data saya akan diproses sesuai
              dengan kebijakan yang berlaku.
            </label>
          </div>
          {errors.agreeToTerms && (
            <p className="text-sm text-red-600 animate-fade-in ml-7">
              {errors.agreeToTerms}
            </p>
          )}
          ...
          <div className="flex items-start space-x-3">
            ...
            <label
              ...
              className="text-sm text-gray-600 leading-relaxed"
            >
              Ya, saya ingin menerima update tentang fitur baru, tips literasi,
              webinar, dan penawaran khusus via email. Anda bisa berhenti
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
            <div className="flex items-start gap-3 p-3 bg-white rounded-lg border border-green-100">
              ...
              <div>
                ...
                <div className="text-green-700 text-xs mt-1">
                  Akses konten berkualitas dari pakar
                </div>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-white rounded-lg border border-green-100">
              ...
              <div>
                ...
                <div className="text-green-700 text-xs mt-1">
                  Rekomendasi sesuai level & minat
                </div>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-white rounded-lg border border-green-100">
            ...
            <div className="flex items-start gap-3 p-3 bg-white rounded-lg border border-green-100">
              ...
              <div>
                ...
                <div className="text-green-700 text-xs mt-1">
                  Track perkembangan dan dapatkan sertifikat
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-blue-700 text-xs mt-1">
              Kami menggunakan enkripsi SSL dan tidak pernah membagikan data
